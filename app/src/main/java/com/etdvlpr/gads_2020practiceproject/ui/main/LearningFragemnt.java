...
public class LearningFragemnt  extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        Call<List<Learner>> learners = service.getLearningLeaders();
        learners.enqueue(new Callback<List<Learner>>() {
            ...
            public void onResponse(Call<List<Learner>> call, Response<List<Learner>> response) {
                ...
                LeaderBoardAdapter adapter = new LeaderBoardAdapter((ArrayList<Learner>) response.body(), "Learning hours");
